    ...
    messages: {
        cases: [
                            ...
                            messages: [
                                ...
                                },
                                {
                                    ...
                                    state: `{
                                        ...
                                        var['auction.'||$reference||'.auction_status'] = 'finished';
            ...
            { // buyer confirms data to seller sent
                if: `{ !!trigger.data.buyer_data_confirm AND var['auction.'||trigger.data.reference||'.auction_status'] == 'finished'}`,
                init: `{
                    $reference = trigger.data.reference;
                    $buyer = trigger.address;
                }`,
            ...
            { // buyer confirms goods receipt
                if: `{ !!trigger.data.goods_receipt AND var['auction.'||trigger.data.reference||'.auction_status'] == 'buyer_data_confirm'}`,
                init: `{
                    $reference = trigger.data.reference;
                }`,
                messages: [
            ...
            { // buyer did not receive goods
                if: `{ !!trigger.data.no_goods_receipt AND var['auction.'||trigger.data.reference||'.auction_status'] == 'buyer_data_confirm'}`,
                init: `{
                    $reference = trigger.data.reference;
                }`,
                messages: [
